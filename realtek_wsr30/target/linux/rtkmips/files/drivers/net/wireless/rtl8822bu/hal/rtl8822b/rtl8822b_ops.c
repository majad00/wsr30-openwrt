...
/* Manual definition to resolve dependency without header bloat */
#ifndef S0S1_SW_ANTDIV
    #define S0S1_SW_ANTDIV 0x06
#endif
...
#ifndef RT_BCN_INT_MASKS
#define RT_BCN_INT_MASKS 0
#endif
...
#ifndef RT_BCN_INT_MASKS
#define RT_BCN_INT_MASKS (BIT(20) | BIT(25) | BIT(26) | BIT(16))
#endif
...
// majad add this function
void rtl8822b_set_hal_ops(PADAPTER adapter)
{
	struct hal_com_data *hal;
	struct hal_ops *ops;

	// 1. Get the pointers correctly
	hal = GET_HAL_DATA(adapter);
	...
	// ... [Rest of your function code remains the same below this] ...
    // ... [Just ensure you don't redeclare 'struct hal_ops *ops' inside again] ...
}