 ...
 * Hsinchu 300, Taiwan.
 *
 * WSR30 port is made by majad .qureshi @ lut .fi
 *
 *****************************************************************************/
...
#ifndef H2C_88XX_RSSI_REPORT
    #define H2C_88XX_RSSI_REPORT 0x42
    #define H2C_88XX_RA_PARA_ADJUST 0x46
    #define H2C_88XX_FW_TRACE_EN 0x49
#endif
...
/* @2 OutSrc Header Files  the phydm typs added by majad*/
...
// the following block added by majad
#include <basic_types.h>
#ifndef u8
