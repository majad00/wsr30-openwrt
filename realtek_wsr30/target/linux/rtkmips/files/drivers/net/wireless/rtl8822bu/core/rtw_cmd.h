...
#ifdef CONFIG_AP_MODE
/* Modified by majad to match the call in rtw_mlme.c */
u8 rtw_change_bss_chbw_cmd(_adapter *padapter, u8 flags, u16 ifbmp, u8 wait_ms, u8 ch_info, u8 bw_info, u8 offset_info);
