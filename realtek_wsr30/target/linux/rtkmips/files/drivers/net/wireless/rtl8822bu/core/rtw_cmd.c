 ...
 * more details.
 * ported by majad  @ lut for WSR30
 *****************************************************************************/
#define _RTW_CMD_C_

#include "drv_types.h"
#include "hal_data.h"
#include "os_dep_service.h"
...
int _rtw_enqueue_cmd(_queue *queue, struct cmd_obj *obj, bool to_head)
{
	_irqL irqL;
...
inline u8 rtw_change_bss_chbw_cmd(_adapter *padapter, u8 flags, u16 ifbmp, u8 wait_ms, u8 ch_info, u8 bw_info, u8 offset_info)
{
    /* Modified to bypass broken Realtek source code */
    /* The original code tried to use 'req_ch' etc. which are not defined here */
    return _FAIL;
}
