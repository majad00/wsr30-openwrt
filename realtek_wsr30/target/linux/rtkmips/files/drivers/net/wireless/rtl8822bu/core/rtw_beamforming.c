...
/* Added by majad */
struct adapter;
extern u8 beamforming_get_htndp_tx_rate(void *pDM_Void, u8 column);
extern u8 beamforming_get_vht_ndp_tx_rate(void *pDM_Void, u8 column);

#ifndef HALMAC_OFDM24
    #define HALMAC_OFDM24 0x0C
#endif

#ifndef CMD_ID_C2H_SND_TXBF
    #define CMD_ID_C2H_SND_TXBF 0x1E
#endif
