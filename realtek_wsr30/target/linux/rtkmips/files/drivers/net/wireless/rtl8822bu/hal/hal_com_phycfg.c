 ...
 * more details.
 *
 * port made by majad at lut.fi for WSR30
 *****************************************************************************/
...
s8 phy_get_txpwr_regd_lmt(_adapter *adapter, struct hal_spec_t *hal_spec, u8 cch, enum channel_width bw, u8 ntx_idx)
{
	...
	if (0) {
	// ((adapter->registrypriv.RegEnableTxPowerLimit == 2 && hal_data->EEPROMRegulatory != 1) ||
	//	adapter->registrypriv.RegEnableTxPowerLimit == 0)
		goto exit;
			}
