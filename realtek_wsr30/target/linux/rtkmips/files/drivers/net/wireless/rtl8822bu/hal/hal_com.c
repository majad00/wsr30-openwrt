...
/* Manual Fix for Antenna Diversity constants 
#ifndef MAIN_ANT
    #define MAIN_ANT 1
#endif
#ifndef AUX_ANT
...
#if 0 /* majad disbale it to fix MIPS build errors and save binary size */
...
#ifdef CONFIG_RTL8812A
u8 * rtw_hal_set_8812a_vendor_ie(_adapter *padapter , u8 *pframe ,unsigned int *frlen ) {
	int vender_len = 7;
