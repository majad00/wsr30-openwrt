 ...
 * more details.
 *
 *Port is doene by majad at lut.fi
 *****************************************************************************/
...
// added by majad
	...
	/* Force export the core USB IO symbols */
		EXPORT_SYMBOL(usb_read8);
		EXPORT_SYMBOL(usb_read16);
		EXPORT_SYMBOL(usb_read32);
		EXPORT_SYMBOL(usb_write8);
		EXPORT_SYMBOL(usb_write16);
		EXPORT_SYMBOL(usb_write32);	
