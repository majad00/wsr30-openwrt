 ...
 * more details.
 *port is done by majad for WSR30
 *
 *****************************************************************************/
...
#undef RTL_R32
#undef RTL_W32
#define RTL_R32(offset)      rtw_read32(adapter, offset)
#define RTL_W32(offset, val) rtw_write32(adapter, offset, val)
// If it complains about R8 or R16, add them here too:
#define RTL_R8(offset)       rtw_read8(adapter, offset)
#define RTL_W8(offset, val)  rtw_write8(adapter, offset, val)
...
extern unsigned int ioreq_flush(_adapter *adapter, struct io_queue *ioqueue);
extern void sync_ioreq_enqueue(struct io_req *preq, struct io_queue *ioqueue);
extern unsigned int sync_ioreq_flush(_adapter *adapter, struct io_queue *ioqueue);


extern unsigned int free_ioreq(struct io_req *preq, struct io_queue *pio_queue);
extern struct io_req *alloc_ioreq(struct io_queue *pio_q);

extern unsigned int register_intf_hdl(u8 *dev, struct intf_hdl *pintfhdl);
...
extern unsigned int async_read8(_adapter *adapter, u32 addr, u8 *pbuff,
	void (*_async_io_callback)(_adapter *padater, struct io_req *pio_req, u8 *cnxt), u8 *cnxt);
extern unsigned int async_read16(_adapter *adapter, u32 addr,  u8 *pbuff,
	void (*_async_io_callback)(_adapter *padater, struct io_req *pio_req, u8 *cnxt), u8 *cnxt);
extern unsigned int async_read32(_adapter *adapter, u32 addr,  u8 *pbuff,
	void (*_async_io_callback)(_adapter *padater, struct io_req *pio_req, u8 *cnxt), u8 *cnxt);
...
extern unsigned int alloc_io_queue(_adapter *adapter);
