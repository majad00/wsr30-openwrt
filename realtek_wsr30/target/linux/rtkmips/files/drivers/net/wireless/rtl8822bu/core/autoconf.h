...
// this blcok is added by majad qureshi
#define CONFIG_BIG_ENDIAN
#undef CONFIG_LITTLE_ENDIAN
#define CONFIG_IOCTL_CFG80211 1
#define RTW_USE_CFG80211_STA_EVENT 1
#define DM_ODM_SUPPORT_TYPE 0x04  /* This is the value for ODM_CE (Linux) */
#define ODM_CE 0x04
#define ODM_AP 0x01
#define CONFIG_RTW_UP_MAPPING_RULE 0

// next block added by majad
