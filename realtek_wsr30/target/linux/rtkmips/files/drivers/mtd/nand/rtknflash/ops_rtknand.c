...
/* to adjust WSR30 boot mtd blocks for openwrt
static struct mtd_partition rtl8196_parts1[] = {
      ...
      {name: "root_test", offset: 0xe00000, size:0x1A00000,},
...
*/
//Added by majad to handle WSR30 buggy driver
static struct mtd_partition rtl8196_parts1[] = {
    { name: "boot",    offset: 0x00000000, size: 0x00500000, mask_flags: MTD_WRITEABLE }, /* Read-Only */
    { name: "setting", offset: 0x00500000, size: 0x00300000, mask_flags: MTD_WRITEABLE }, /* Read-Only */
    { name: "linux",   offset: 0x00800000, size: 0x00600000 }, 
    { name: "rootfs2",  offset: 0x00e00000, size: 0x04200000 }, 
    { name: "config",  offset: 0x05000000, size: 0x00800000 }, 
    { name: "linux2",  offset: 0x05800000, size: 0x00600000 }, 
    { name: "rootfs", offset: 0x05e00000, size: 0x04200000 }, 
    { name: "app",     offset: 0x0a000000, size: 0x03000000 }, 
    { name: "rootfs_data",     offset: 0x0d000000, size: 0x08000000 }, 
};
...
#else
	/* use default bbt: not support second line added by majad*/
	rtkn->nand_chip->bbt_options 		= NAND_BBT_USE_FLASH | NAND_BBT_NO_OOB;
	//rtkn->nand_chip->bbt_options = 0;
#endif
	/* ecc */
