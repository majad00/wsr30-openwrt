...
/* added to port SWR30 openwrt build as these two OUTSIDE the ifdef so they are always visible */
/* [FIX] Match definitions to rtw_odm.c */
struct dvobj_priv; /* Forward declaration so the compiler knows what this struct is */
