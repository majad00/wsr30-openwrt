 ...
 * Ported to WSR30 by majad at lut.fi
 *
 *****************************************************************************/
 ...
 * 1 ============================================================
 ***************************************************************/
#ifndef __LINUX_OS_FORCED__
#define __LINUX_OS_FORCED__
    #define DM_ODM_SUPPORT_TYPE 0x01  
    #define LINUX_KLI                 
    ...
    /* Fallback for Station count if the main config is missing */
    #ifndef NUM_STAT
        #define NUM_STAT 32
    #endif
#endif
...
/* added by maajd to fix the unknown 'boolean' type safely */
/* We check for common Realtek guards to see if it's already defined */
#if !defined(BOOLEAN_DEFINED) && !defined(_BASIC_TYPES_H_)
