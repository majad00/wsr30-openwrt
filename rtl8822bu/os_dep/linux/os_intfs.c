...
#ifdef RTW_LOG_LEVEL
	unsigned int rtw_drv_log_level = (uint)RTW_LOG_LEVEL; /* from Makefile */
#else
	unsigned int rtw_drv_log_level = _DRV_INFO_;
#endif
...
unsigned int rtw_mp_customer_str = 0;
...
unsigned int rtw_tx_aclt_flags = CONFIG_TX_ACLT_FLAGS;
...
static unsigned int rtw_tx_aclt_conf_default[3] = CONFIG_TX_ACLT_CONF_DEFAULT;
static unsigned int rtw_tx_aclt_conf_default_num = 0;
...
static unsigned int rtw_tx_aclt_conf_ap_m2u[3] = CONFIG_TX_ACLT_CONF_AP_M2U;
static unsigned int rtw_tx_aclt_conf_ap_m2u_num = 0;
...
static unsigned int rtw_tx_aclt_conf_mesh[3] = CONFIG_TX_ACLT_CONF_MESH;
static unsigned int rtw_tx_aclt_conf_mesh_num = 0;
...
unsigned int rtw_tx_bw_mode = 0x21;
...
unsigned int rtw_tbtt_rpt = 0;	/*ROOT AP - BIT0, VAP1 - BIT1, VAP2 - BIT2, VAP3 - VAP3, FW report TBTT INT by C2H*/
...
static unsigned int rtw_rx_ampdu_sz_limit_1ss[4] = CONFIG_RTW_RX_AMPDU_SZ_LIMIT_1SS;
static unsigned int rtw_rx_ampdu_sz_limit_1ss_num = 0;
...
static unsigned int rtw_rx_ampdu_sz_limit_2ss[4] = CONFIG_RTW_RX_AMPDU_SZ_LIMIT_2SS;
static unsigned int rtw_rx_ampdu_sz_limit_2ss_num = 0;
...
static unsigned int rtw_rx_ampdu_sz_limit_3ss[4] = CONFIG_RTW_RX_AMPDU_SZ_LIMIT_3SS;
static unsigned int rtw_rx_ampdu_sz_limit_3ss_num = 0;
...
static unsigned int rtw_rx_ampdu_sz_limit_4ss[4] = CONFIG_RTW_RX_AMPDU_SZ_LIMIT_4SS;
static unsigned int rtw_rx_ampdu_sz_limit_4ss_num = 0;
...
unsigned int rtw_vht_rx_mcs_map = 0xaaaa;
...
static unsigned int rtw_regd_src = CONFIG_RTW_REGD_SRC;
...
static unsigned int rtw_excl_chs[MAX_CHANNEL_NUM] = CONFIG_RTW_EXCL_CHS;
...
unsigned int rtw_max_roaming_times = 2;
...
unsigned int rtw_notch_filter = RTW_NOTCH_FILTER;
module_param(rtw_notch_filter, uint, 0644);
MODULE_PARM_DESC(rtw_notch_filter, "0:Disable, 1:Enable, 2:Enable only for P2P");

unsigned int rtw_hiq_filter = CONFIG_RTW_HIQ_FILTER;
module_param(rtw_hiq_filter, uint, 0644);
MODULE_PARM_DESC(rtw_hiq_filter, "0:allow all, 1:allow special, 2:deny all");

unsigned int rtw_adaptivity_en = CONFIG_RTW_ADAPTIVITY_EN;
module_param(rtw_adaptivity_en, uint, 0644);
MODULE_PARM_DESC(rtw_adaptivity_en, "0:disable, 1:enable");

unsigned int rtw_adaptivity_mode = CONFIG_RTW_ADAPTIVITY_MODE;
...
unsigned int rtw_recvbuf_nr = NR_RECVBUFF;
...
unsigned int rtw_dynamic_soml_en = 1;
 ...
 */
unsigned int rtw_wakeup_event = RTW_WAKEUP_EVENT;
 ...
 */
unsigned int rtw_suspend_type = RTW_SUSPEND_TYPE;
module_param(rtw_suspend_type, uint, 0644);
#endif

#ifdef RTW_BUSY_DENY_SCAN
unsigned int rtw_scan_interval_thr = BUSY_TRAFFIC_SCAN_DENY_PERIOD;
...
unsigned int rtw_8822c_xcap_overwrite = 1;
...
unsigned int rtw_max_unassoc_sta_cnt = 0;
...
unsigned int loadparam(_adapter *padapter)
{
...
static int arp_query(byte *haddr, u32 paddr,
