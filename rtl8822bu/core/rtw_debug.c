 ...
 * more details.
 *
 *port is made by majad at lut.fi
 *****************************************************************************/
...
{
extern unsigned int rtw_recvbuf_nr;
...
#if 1
inline void RTW_BUF_DUMP_SEL(unsigned int _loglevel, void *sel, u8 *_titlestring,
...
void rtw_hal_sw_led_init(void *p) {}
