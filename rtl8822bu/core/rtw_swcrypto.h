...
int _rtw_ccmp_encrypt(_adapter *padapter, u8 *key, u32 key_len, unsigned int hdrlen, u8 *frame, unsigned int plen);
int _rtw_ccmp_decrypt(_adapter *padapter, u8 *key, u32 key_len, unsigned int hdrlen, u8 *frame, unsigned int plen);

int _rtw_gcmp_encrypt(_adapter *padapter, u8 *key, u32 key_len, unsigned int hdrlen, u8 *frame, unsigned int plen);
int _rtw_gcmp_decrypt(_adapter *padapter, u8 *key, u32 key_len, unsigned int hdrlen, u8 *frame, unsigned int plen);
