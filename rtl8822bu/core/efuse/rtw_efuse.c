 ...
 * more details.
 *por for WSR30 is made by majad at lut .fi
 *
 *****************************************************************************/
...
// added by majad
#include <rtl8822b_spec.h>
#include <hal_com_reg.h>

/* Manual defines for missing constants if the headers still don't bridge them */
#ifndef bMaskDWord
    #define bMaskDWord 0xffffffff
#endif

#ifndef REG_RCR
    #define REG_RCR 0x0440
#endif

#ifndef REG_RXFLTMAP0
    #define REG_RXFLTMAP0 0x044C
#endif
...
void rtw_efuse_mask_array(PADAPTER pAdapter, u8 *pArray)
{
	...
	if (IS_HARDWARE_TYPE_8822B(pAdapter)) {
		#ifdef CONFIG_USB_HCI
			GET_MASK_ARRAY(8822B, _USB, pArray);
		#else
