...
struct ieee80211_frag_entry {
	...
	unsigned int qos;   /* jackson */
	unsigned int tid;	/* jackson */
	struct sk_buff *skb;
...
u8 *rtw_set_ie(u8 *pbuf, int index, unsigned int len, const u8 *source, unsigned int *frlen);
...
u8 *rtw_bss_ex_get_p2p_ie(WLAN_BSSID_EX *bss_ex, u8 *p2p_ie, unsigned int *p2p_ielen);
...
u8 *rtw_bss_ex_get_wfd_ie(WLAN_BSSID_EX *bss_ex, u8 *wfd_ie, unsigned int *wfd_ielen);
