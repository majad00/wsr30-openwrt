...
int validate_beacon_len(u8 *pframe, unsigned int len);
...
void update_beacon_info(_adapter *padapter, u8 *pframe, unsigned int len, struct sta_info *psta);
#if CONFIG_DFS
...
extern void update_TSF(struct mlme_ext_priv *pmlmeext, u8 *pframe, unsigned int len);
